 ...
 <div id="box">
        ...
        <form id="joinForm" action="/join.do" method="post" onsubmit="return validateForm(this)">
            ...
            <div class="content email">
                ...
                <input type="text" name="email_behind" id="email_self">
                <select id="email_behind_sel">
                    <option class="self" value="1">직접입력</option>
                ...
                <input type="checkbox" name="email_agree" value="1">
                    Email 마케팅 수신 동의(선택)
	            </div>
            </div>
            <label for="number" class="subject_with">휴대전화</label>
            <div class="content phone">
                <select name="number_first" id="number">
                    <option value="010">010</option>
                    <option value="011">011</option>
                    <option value="019">019</option>
                </select>
                -
                <input type="text" name="number_second">
                -
                <input type="text" name="number_third">
	            <div class="agree_marketing">
	                <input type="checkbox" name="phone_agree" value="1">
	                    휴대폰 마케팅 수신 동의(선택)
	            </div>
            </div>
